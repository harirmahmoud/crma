...
function useAuth() {
    ...
    const { getToken, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$client$2d$boundary$2f$PromisifiedAuthProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__usePromisifiedAuth__as__useAuth$3e$__["useAuth"])();
    return {
        user,
        isLoaded,
        isSignedIn,
...
_s(useAuth, "EEEGcTNXgs7ytI8wk2xVk7lOY5s=", false, function() {
    return [
...
function UserNav() {
    _s();
    const { user, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const initials = user.firstName && user.lastName ? `${user.firstName[0]}${user.lastName[0]}` : user.emailAddresses[0]?.emailAddress[0].toUpperCase() || "U";
...
_s(UserNav, "p25EqY+ph/7kPIJ5Ow6afH+fokk=", false, function() {
    return [
...
//# sourceMappingURL=_83c45081._.js.map